...
serviceCode = serviceCode.replace(
  /\.get\(\) as any/g,
  ".get() as { id: string; siteUrl: string; displayName: string | null; blogTitle: string | null; avatarUrl: string | null; lastFetchedAt: string | null; createdAt: string; remoteBlogId: string; remoteId: string; name: string; slug: string; description: string | null; }",
);
