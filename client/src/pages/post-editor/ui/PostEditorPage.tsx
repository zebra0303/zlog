...
import { sanitizeHtml as secureSanitizeHtml } from "@/shared/lib/security/sanitize";
            ...
            <Card className="w-full">
              <CardContent className="pt-6">
                {/* 
                  ...
                  Additionally, DOMPurify is run before rendering for maximum safety.
                */}
                <div
                  className="prose prose-lg dark:prose-invert max-w-none"
                  dangerouslySetInnerHTML={{ __html: secureSanitizeHtml(sanitizedHtml) }}
                />
