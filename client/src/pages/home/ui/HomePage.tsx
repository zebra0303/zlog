  ...
  return (
    <div>
      ...
      <div className="mb-4 flex items-center gap-2">
        ...
        <a href={currentCategory ? `/category/${currentCategory}/rss.xml` : "/rss.xml"} target="_blank" rel="noopener noreferrer" className="inline-flex shrink-0 items-center gap-1 rounded-lg border border-orange-200 bg-orange-50 px-2.5 py-1.5 text-xs font-medium text-orange-600 transition-colors hover:bg-orange-100 dark:border-orange-800 dark:bg-orange-950 dark:text-orange-400 dark:hover:bg-orange-900" aria-label="RSS Feed">
