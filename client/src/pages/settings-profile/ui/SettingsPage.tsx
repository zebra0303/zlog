    ...
    <div className="flex flex-col gap-6">
      ...
      <Card><CardContent className="pt-6"><h2 className="mb-4 font-semibold text-[var(--color-text)]">{t("settings_avatar")}</h2>
        <div className="flex items-center gap-4">
          ...
          {avatarPreview && <Button variant="destructive" size="sm" onClick={async () => { try { await api.delete("/profile/avatar"); setAvatarPreview(null); } catch {} }}><Trash2 className="mr-1 h-4 w-4" />{t("delete")}</Button>}
