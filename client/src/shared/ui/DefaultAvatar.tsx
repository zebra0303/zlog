    ...
    >
      <defs>
        <linearGradient id="avatarBg" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="100%" stopColor="#D4D0FB" />
        </linearGradient>
      ...
      <g clipPath="url(#circleClip)">
        ...
        <circle cx="106" cy="130" r="12" fill="#333" />
        <circle cx="150" cy="130" r="12" fill="#333" />
        <circle cx="110" cy="126" r="4" fill="white" />
        <circle cx="154" cy="126" r="4" fill="white" />
        <ellipse cx="128" cy="168" rx="15" ry="10" fill="#333" />
        <path
          d="M112 180 Q128 194 144 180"
          stroke="#333"
          strokeWidth="3"
          fill="none"
          strokeLinecap="round"
