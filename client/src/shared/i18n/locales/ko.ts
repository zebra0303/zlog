...
export const ko: Record<TranslationKeys, string> = {
  ...
  post_updated: "수정됨",
  post_saved_success: "게시글이 저장되었습니다.",
  post_view_original: "원본 글 보기",
  post_like_added: "좋아요를 눌렀습니다.",
  post_like_removed: "좋아요를 취소했습니다.",
  post_like_failed: "요청에 실패했습니다.",
  ...
  admin_cat_delete_move_posts:
    "이 카테고리에 {count}개의 글이 있습니다. 글을 이동할 카테고리를 선택하세요.",
  admin_cat_move_target: "이동할 카테고리",
  admin_cat_delete_with_move: "이동 후 삭제",
  ...
  toolbar_emoji: "이모지",
  toolbar_sticker: "스티커",
  sticker_search_placeholder: "스티커 검색...",
  sticker_powered_by: "Powered by GIPHY",
