...
다른 ZLOG 사용자의 특정 카테고리를 구독하여 내 블로그에서 내가 원하는 디자인으로 모아볼 수 있습니다. 관심 분야가 비슷한 친구들이나 동호회원들이 각자 블로그를 운영하면서 서로의 글을 구독해 피드를 구성해 보면 재미있을 것 같다는 생각에서 시작했습니다.

> [**라이브 데모 — zlog.pe.kr**](http://zlog.pe.kr)
