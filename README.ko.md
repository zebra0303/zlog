...
- **연결을 통한 발견**: 내 글이 아닌 다른 사람의 글을 통해서도 새로운 zloger를 발견하고 방문할 수 있는, 흐르는 형태의 커뮤니티를 지향합니다.
- **취향의 구독**: 나의 카테고리가 마음에 드는 다른 zloger는 해당 카테고리를 구독해 자신의 블로그 피드에 실시간으로 통합할 수 있습니다.
